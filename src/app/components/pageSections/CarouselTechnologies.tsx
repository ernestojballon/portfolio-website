    ...
    <TwoSectionsWithCarousel
      slot1={[
        <React.Fragment key="Technologies">
          ...
          <p className="body">
            My greater strength lies in front-end development, but I&apos;m also
            very comfortable with back-end technologies. I&apos;ve worked with a
            diverse array of tools and frameworks, with React, AWS, and Node.js
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
            <div>
              ...
              <SkillItem
                Icon={BeakerIcon}
                skill="TypeScript for type-safe code"
              />
              <SkillItem
                Icon={CpuChipIcon}
                skill="Tailwind CSS for rapid styling"
              />
            </div>
            <div>
              ...
              <SkillItem
                ...
                skill="Node.js with Express.js"
              />
              <SkillItem
                Icon={CloudIcon}
                skill="AWS services (Lambda, S3, EC2, etc.)"
              />
              <SkillItem
                Icon={CodeBracketIcon}
                skill="RESTful API design and GraphQL"
              />
              <SkillItem
