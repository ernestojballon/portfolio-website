...
export type ScrollingLayoutProps = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;
...
const ScrollingLayout = (props: ScrollingLayoutProps) => {
  ...
  return (
    <div ref={containerRef} className={`relative min-h-[150vh] w-[100%] flex ${isMobile && "flex-col"}  `}>
      <motion.section
      ...
      >
        <div className="relative w-full h-full border-2 border-black ">
          ...
          <img src={mainBackgroundImage} alt="Background" className="w-full h-full object-cover" />
