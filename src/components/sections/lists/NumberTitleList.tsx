...
export type NumberTitleListProps = React.ComponentPropsWithoutRef<"section"> & Partial<Props>;

export const NumberTitleList = (props: NumberTitleListProps) => {
  const { features } = {
    ...NumberTitleListDefaults,
    ...props,
  } as Props;
  ...
  return (
    <section ref={ref} className="px-[5%] py-16 md:py-24 lg:py-28">
      <div className="container relative grid auto-cols-fr grid-cols-1 items-start gap-x-8 gap-y-12 md:grid-cols-[0.75fr_1fr] md:gap-y-16 lg:grid-cols-[max-content_1fr] lg:gap-x-8">
...
const FeatureCard = ({ ...feature }: Feature) => {
  ...
  return (
    <div className="flex flex-col items-start justify-center py-8 md:py-0">
      <div className="mt-10 flex text-[5rem] font-bold leading-[1] md:mt-0 md:hidden md:text-[14rem]">
        {feature.number}
      </div>
      ...
      <h2 className="rb-5 mb-5 h2 font-bold md:mb-6 ">
        {feature.heading}
      </h2>
...
export default NumberTitleList;